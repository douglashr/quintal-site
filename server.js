...
const app = express();
const PORT = process.env.PORT || 3000; // Use a porta dinâmica do Glitch
...
app.use(express.static(__dirname)); // Certifique-se de que os arquivos estáticos estão acessíveis
